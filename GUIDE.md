...
- Golden set собран по демо-заметкам и покрывает их не равномерно. Он показывает
  порядок величины, а не абсолютное качество: набор небольшой, и часть записей
  начиналась как черновики модели.
